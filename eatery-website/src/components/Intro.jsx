...
const Intro = () => {
  return (
    <div className='w-full h-auto bg-cover py-10' style={{ backgroundImage: `url(${bgImage1})` }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-2.5 gap-y-6 px-3.5 pt-5.5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4 text-start justify-items-center md:justify-items-start">
                <img className='w-full max-w-sm rounded h-fit shadow-lg' src={Meal1} alt="" />
                <img className='w-full max-w-sm rounded h-fit shadow-lg md:mt-8' src={Meal2} alt="" />

            </div>
            <div className="w-auto px-3.5 py-5 text-center md:text-start">
                <h1 className="leading font-light text-4xl md:text-5xl lg:text-6xl text-start font-monospace text-amber-500">Our Story</h1>
                <br />
                <p className="h2 text-lg md:text-xl lg:text-2xl text-start font-bolder text-amber-500 pt-4.5">We believe the best conversations and the greatest memories are born around food.
                    <br /> The camraderie,
                     the sense of community and the joy that fills the room is why we do what we do.</p>
                <p className="h2 text-lg md:text-xl lg:text-2xl text-start font-bolder text-amber-500 pt-4.5">We believe the best conversations and the greatest memories are born around food.
                    <br /> The camraderie,
                     the sense of community and the joy that fills the room is why we do what we do.</p>
                     <br />
